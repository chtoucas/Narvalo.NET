...
namespace Narvalo.Fx.Samples
{
    ...
    public static partial class MonadZero
    {
        ...
        public static MonadZero<global::Narvalo.Fx.Unit> Unit
        {
            get
            {
                Ensures(Result<MonadZero<global::Narvalo.Fx.Unit>>() != null);
        ...
        public static Func<MonadZero<T>, MonadZero<TResult>> Lift<T, TResult>(
            ...
            /* T4: C# indent */
        {
            Ensures(Result<Func<MonadZero<T>, MonadZero<TResult>>>() != null);
        ...
        public static Func<MonadZero<T1>, MonadZero<T2>, MonadZero<TResult>>
            ...
            /* T4: C# indent */
        {
            Ensures(Result<Func<MonadZero<T1>, MonadZero<T2>, MonadZero<TResult>>>() != null);
        ...
        public static Func<MonadZero<T1>, MonadZero<T2>, MonadZero<T3>, MonadZero<TResult>>
            ...
            /* T4: C# indent */
        {
            Ensures(Result<Func<MonadZero<T1>, MonadZero<T2>, MonadZero<T3>, MonadZero<TResult>>>() != null);
        ...
        public static Func<MonadZero<T1>, MonadZero<T2>, MonadZero<T3>, MonadZero<T4>, MonadZero<TResult>>
            ...
            /* T4: C# indent */
        {
            Ensures(Result<Func<MonadZero<T1>, MonadZero<T2>, MonadZero<T3>, MonadZero<T4>, MonadZero<TResult>>>() != null);
        ...
        public static Func<MonadZero<T1>, MonadZero<T2>, MonadZero<T3>, MonadZero<T4>, MonadZero<T5>, MonadZero<TResult>>
            ...
            /* T4: C# indent */
        {
            Ensures(Result<Func<MonadZero<T1>, MonadZero<T2>, MonadZero<T3>, MonadZero<T4>, MonadZero<T5>, MonadZero<TResult>>>() != null);
    ...
    public static partial class MonadZero
    {
            ...
            /* T4: C# indent */
        {
            ...
            Demand.NotNull(innerKeySelector);
            Ensures(Result<Func<TSource, MonadZero<TKey>>>() != null);
    ...
    /// <content>
    /// Provides non-standard extension methods for <see cref="MonadZero{T}" />.
    /// </content>
    public static partial class MonadZero
    {
...
namespace Narvalo.Fx.Samples
{
    ...
    /// <content>
    /// Provides extension methods for <see cref="IEnumerable{T}"/> where <c>T</c> is a <see cref="MonadZero{S}"/>.
    /// </content>
