...
namespace Narvalo.Reliability
{
    ...
    public partial class CircuitBreakerFacts
    {
        ...
        [Theory]
        [MemberData("MaxRetriesLessThanThreshold")]
        [CLSCompliant(false)]
        ...
        [Theory]
        [MemberData("MaxRetriesOverOrEqualToThreshold")]
        [CLSCompliant(false)]
        ...
        [Theory]
        [MemberData("MaxRetriesUnderThreshold")]
        [CLSCompliant(false)]
        ...
        public void Execute_FaultyAction_WhenClosed_ThrowsAggregateException()
        {
            ...
            // Act & Assert
            var ex = Assert.Throws<AggregateException>(() => { cb.Invoke(op, policy); });
            int index = 0;
            Assert.True(
