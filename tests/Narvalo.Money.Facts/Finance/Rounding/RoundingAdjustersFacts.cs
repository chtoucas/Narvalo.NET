...
namespace Narvalo.Finance.Rounding
{
    ...
    public static partial class RoundingAdjustersFacts
    {
        #region Round()
        ...
        {
            Func<decimal, decimal> round = _ => RoundingAdjusters.Round(_, RoundingMode.Down);
        ...
        {
            Func<decimal, decimal> round = _ => RoundingAdjusters.Round(_, RoundingMode.Up);
        ...
        {
            Func<decimal, decimal> round = _ => RoundingAdjusters.Round(_, RoundingMode.TowardsZero);
        ...
        public static void Round_HalfUp(decimal value, decimal expectedValue)
            => Assert.Equal(expectedValue, RoundingAdjusters.Round(value, RoundingMode.HalfUp));

        [Fact]
        public static void Round_HalfUp_ForHalfWayPoints()
        {
            Func<decimal, decimal> round = _ => RoundingAdjusters.Round(_, RoundingMode.HalfUp);
        ...
        public static void Round_HalfTowardsZero(decimal value, decimal expectedValue)
            => Assert.Equal(expectedValue, RoundingAdjusters.Round(value, RoundingMode.HalfTowardsZero));

        [Fact]
        public static void Round_HalfTowardsZero_ForHalfWayPoints()
        {
            Func<decimal, decimal> round = _ => RoundingAdjusters.Round(_, RoundingMode.HalfTowardsZero);
        ...
        public static void Round_ToEven(decimal value, decimal expectedValue)
            => Assert.Equal(expectedValue, RoundingAdjusters.Round(value, RoundingMode.ToEven));

        [Fact]
        public static void Round_ToEven_ForHalfWayPoints()
        {
            Func<decimal, decimal> round = _ => RoundingAdjusters.Round(_, RoundingMode.ToEven);
