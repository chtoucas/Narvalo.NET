...
namespace Narvalo.Applicative {
    ...
    public static partial class MaybeFacts {
        ...
        public static void ReplaceBy1() {
            ...
            var m2 = MaybeL.ReplaceBy(some, exp);
            Assert.True(m2.IsSome);
        }
        ...
        public static void ReplaceBy2() {
            ...
            var m2 = MaybeL.ReplaceBy(none, exp);
            Assert.True(m2.IsNone);
        }
        ...
        public static void ContinueWith1() {
            ...
            var m2 = MaybeL.ContinueWith(some, exp);
            Assert.Equal(exp, m2);
        }
        ...
        public static void ContinueWith2() {
            ...
            var m2 = MaybeL.ContinueWith(none, other);
            Assert.True(m2.IsNone);
        }
        ...
        public static void PassBy1() {
            ...
            var m2 = MaybeL.PassBy(some, other);
            ...
            var m4 = MaybeL.PassBy(none, other);
        ...
        public static void Select1() {
            ...
            var m2 = MaybeL.Select(some, selector);
            Assert.True(m2.IsSome);
        ...
        public static void Select2() {
            ...
            var m2 = MaybeL.Select(none, selector);
            Assert.True(m2.IsNone);
        ...
        public static void Where1() {
            ...
            var m2 = MaybeL.Where(some, predicate);
            Assert.True(m2.IsNone);
        ...
        public static void SelectMany1() {
            ...
            var m2 = MaybeL.SelectMany(none, valueSelector, resultSelector);
            Assert.True(m2.IsNone);
        ...
        public static void SelectMany2() {
            ...
            var m2 = MaybeL.SelectMany(none1, valueSelector, resultSelector);
            Assert.True(m2.IsNone);
        ...
        public static void SelectMany3() {
            ...
            var m2 = MaybeL.SelectMany(some, valueSelector, resultSelector);
            Assert.True(m2.IsNone);
        ...
        public static void Join1() {
            ...
            var m2 = MaybeL.Join(some1, some2, i => i, i => i, (i, j) => i + j);
            Assert.True(m2.IsNone);
    ...
    public static partial class MaybeFacts {
        ...
        public static void SelectMany4() {
            ...
            var m2 = MaybeL.SelectMany(source, valueSelector, resultSelector);
            Assert.True(m2.IsSome);
        ...
        public static void Join2() {
            ...
            var m2 = MaybeL.Join(source, inner, i => 2 * i, i => i, (i, j) => i + j);
            Assert.True(m2.IsSome);
            Assert.Equal(3, m2.Value);
