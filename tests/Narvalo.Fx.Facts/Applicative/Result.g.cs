...
namespace Narvalo.Applicative {
    ...
    public static partial class ResultFacts {
        ...
        public static void Collect0() {
            IEnumerable<Result<int, My.Obj>> source = null;

            Assert.Throws<ArgumentNullException>("source", () => Result.Collect(source));
        }

        [t("Filter() guards.")]
        public static void Filter0() {
            Func<int, Result<bool, My.Obj>> predicate = _ => Result<bool, My.Obj>.Of(true);

            IEnumerable<int> nil = null;
            Assert.Throws<ArgumentNullException>("source", () => Result.Filter(nil, predicate));

            var source = Enumerable.Range(0, 1);
            Assert.Throws<ArgumentNullException>("predicate", () => Result.Filter(source, default(Func<int, Result<bool, My.Obj>>)));
        }
        ...
        public static void ZipWith0() {
            ...
            // Static method.
            Assert.Throws<ArgumentNullException>("zipper", () => ResultL.ZipWith(first, second, zipper2));
            Assert.Throws<ArgumentNullException>("zipper", () => ResultL.ZipWith(first, second, third, zipper3));
            Assert.Throws<ArgumentNullException>("zipper", () => ResultL.ZipWith(first, second, third, fourth, zipper4));
            Assert.Throws<ArgumentNullException>("zipper", () => ResultL.ZipWith(first, second, third, fourth, fifth, zipper5));
        }
        ...
        public static void Select0() {
            ...
            Assert.Throws<ArgumentNullException>("selector", () => ResultL.Select(source, selector));
        }

        [t("Using() guards.")]
        public static void Using0() {
            var source = Result<DisposableObj, My.Obj>.Of(new DisposableObj());
            Func<DisposableObj, Result<int, My.Obj>> binder = null;
            Func<DisposableObj, int> selector = null;

            Assert.Throws<ArgumentNullException>("binder", () => source.Using(binder));
            Assert.Throws<ArgumentNullException>("binder", () => ResultL.Using(source, binder));

            Assert.Throws<ArgumentNullException>("selector", () => source.Using(selector));
            Assert.Throws<ArgumentNullException>("selector", () => ResultL.Using(source, selector));
        }
        ...
        public static void SelectMany0() {
            ...
            // Static method.
            Assert.Throws<ArgumentNullException>("selector", () => ResultL.SelectMany(source, null, resultSelector));
            Assert.Throws<ArgumentNullException>("resultSelector", () => ResultL.SelectMany(source, valueSelector, (Func<short, int, long>)null));
        }
    ...
    public static partial class ResultFacts {
        ...
        public static bool Repeat01(int arg) {
            var source = Result<int, My.Obj>.Of(arg);

            var result = Result.Repeat(source, 10);
        ...
        public static bool Lift01(int arg0, long arg1) {
            ...
            var selector1 = Result.Lift<int, long, My.Obj>(selector);
        ...
        public static bool Select01(int arg0, long arg1) {
            ...
            var left = selector1(source);
            var right = ResultL.Select(source, selector);
        ...
        public static bool Lift02(int arg0, int arg1, int arg2, int arg3) {
            ...
            var zipper1 = Result.Lift<int, int, long, My.Obj>(zipper);

            var p0 = Result<int, My.Obj>.Of(arg0);
        ...
        public static bool ZipWith02(int arg0, int arg1, int arg2, int arg3) {
            ...
            var left = zipper1(p0, p1);
            var right = ResultL.ZipWith(p0, p1, zipper);
        ...
        public static bool Lift03(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
            ...
            var zipper1 = Result.Lift<int, int, int, long, My.Obj>(zipper);
        ...
        public static bool ZipWith03(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
            ...
            var left = zipper1(p0, p1, p2);
            var right = ResultL.ZipWith(p0, p1, p2, zipper);
        ...
        public static bool Lift04(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
            ...
            var zipper1 = Result.Lift<int, int, int, int, long, My.Obj>(zipper);
        ...
        public static bool ZipWith04(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
            ...
            var left = zipper1(p0, p1, p2, p3);
            var right = ResultL.ZipWith(p0, p1, p2, p3, zipper);
        ...
        public static bool Lift05(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
            ...
            var zipper1 = Result.Lift<int, int, int, int, int, long, My.Obj>(zipper);
        ...
        public static bool ZipWith05(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
            ...
            var left = zipper1(p0, p1, p2, p3, p4);
            var right = ResultL.ZipWith(p0, p1, p2, p3, p4, zipper);
        ...
        public static bool ReplaceBy01b(int arg0, int arg1) {
            var source = Result<int, My.Obj>.Of(arg0);
            var result = ResultL.ReplaceBy(source, arg1);
        ...
        public static bool ContinueWith01b(int arg0, int arg1) {
            var source = Result<int, My.Obj>.Of(arg0);
            var other = Result<int, My.Obj>.Of(arg1);
            var result = ResultL.ContinueWith(source, other);
        ...
        public static bool PassBy01b(int arg0, int arg1) {
            var source = Result<int, My.Obj>.Of(arg0);
            var other = Result<int, My.Obj>.Of(arg1);
            var result = ResultL.PassBy(source, other);
        ...
        public static bool Skip01b(int arg0) {
            var source = Result<int, My.Obj>.Of(arg0);
            var result = ResultL.Skip(source);
        ...
        public static void Using01b() {
            ...
            var source = Result<DisposableObj, My.Obj>.Of(obj);
            Func<DisposableObj, Result<int, My.Obj>> binder = _ => Result<int, My.Obj>.Of(1);
            var result = ResultL.Using(source, binder);
        ...
        public static void Using02b() {
            ...
            var source = Result<DisposableObj, My.Obj>.Of(obj);
            Func<DisposableObj, int> selector = _ => 1;
            var result = ResultL.Using(source, selector);
        ...
        public static bool Apply01b(int arg0, long arg1) {
            ...
            var applied = ResultL.Apply(applicative, value);
            var gathered = ResultL.Gather(value, applicative);

            return applied.Equals(gathered);
        }

        [q("Kleisli.InvokeWith is Result.Map w/ the arguments flipped.")]
        public static bool InvokeWith01(int[] arg0, long arg1) {
            ...
            var selected = Result.Map(arg0, selector);
    ...
    public static partial class ResultFacts {
        ...
        public static bool Of04b(int arg0, float arg1) {
            Func<float, Result<float, My.Obj>> of = Result<float, My.Obj>.Of;
            Func<int, Result<float, My.Obj>> f = x => Result<float, My.Obj>.Of(arg1 * x);
