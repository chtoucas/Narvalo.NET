...
namespace Edufun.Haskell
{
    ...
    public static class PrototypeExtensions
    {
        public static Prototype<TResult> SelectMany<TSource, TMiddle, TResult>(
            this Prototype<TSource> @this,
            Func<TSource, Prototype<TMiddle>> valueSelector,
        ...
        public static Prototype<TResult> Join<TSource, TInner, TKey, TResult>(
            this Prototype<TSource> @this,
            Prototype<TInner> inner,
        ...
        public static Prototype<TResult> GroupJoin<TSource, TInner, TKey, TResult>(
            this Prototype<TSource> @this,
            Prototype<TInner> inner,
            Func<TSource, TKey> outerKeySelector,
            Func<TInner, TKey> innerKeySelector,
            Func<TSource, Prototype<TInner>, TResult> resultSelector)
            => GroupJoinImpl(
                @this,
                inner,
                outerKeySelector,
        ...
        private static Prototype<TResult> JoinImpl<TSource, TInner, TKey, TResult>(
            Prototype<TSource> outer,
            Prototype<TInner> inner,
            Func<TSource, TKey> outerKeySelector,
            Func<TInner, TKey> innerKeySelector,
            Func<TSource, TInner, TResult> resultSelector,
        ...
        private static Prototype<TResult> GroupJoinImpl<TSource, TInner, TKey, TResult>(
            Prototype<TSource> outer,
            Prototype<TInner> inner,
            Func<TSource, TKey> outerKeySelector,
            Func<TInner, TKey> innerKeySelector,
        ...
        private static Func<TSource, Prototype<TKey>> GetKeyLookup<TSource, TInner, TKey>(
            Prototype<TInner> inner,
            Func<TSource, TKey> outerKeySelector,
            Func<TInner, TKey> innerKeySelector,
            IEqualityComparer<TKey> comparer)
