...
namespace MvpWebForms.Presenters
{
        ...
        : HttpPresenter<IWidgetsReadOnlyView, WidgetsReadOnlyModel>
    {
        ...
        private async Task FindingAsync(int id)
        {
        ...
        private IAsyncResult BeginFind(int id, object sender, EventArgs e, AsyncCallback cb, object state)
        {
        ...
        private void EndFind(IAsyncResult ar)
        {
            Widget widget = null;
