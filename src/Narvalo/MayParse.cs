namespace Narvalo
{
    ...
    public static class MayParse
    {
        ...
        {
            return MayParseHelper<decimal>(value, (string val, out decimal result) =>
            {
        ...
        {
            return MayParseHelper<DateTime>(
                value,
        ...
        internal static Maybe<T> MayParseHelper<T>(string value, TryParse<T> fun)
        {
