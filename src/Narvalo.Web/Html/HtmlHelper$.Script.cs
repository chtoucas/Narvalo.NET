namespace Narvalo.Web.Html
{
    ...
    public static partial class HtmlHelperExtensions
    {
        ...
        {
            return Script(@this, scriptUri, scriptType, TypeHelpers.ObjectToDictionary(attributes));
        }
        ...
        static IHtmlString ScriptHelper_(HtmlHelper htmlHelper, Uri scriptUri, string scriptType, IDictionary<string, object> attributes)
        {
