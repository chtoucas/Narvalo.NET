    ...
    public class VirtualAssetProvider : AssetProviderBase
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            if (String.IsNullOrEmpty(baseUrlValue)) {
                ...
                Uri baseUrl;
                if (!Uri.TryCreate(baseUrlValue, UriKind.RelativeOrAbsolute, out baseUrl)) {
        ...
        {
            return new VirtualImageFile(_baseUrl, relativePath, _imageVersion);
        }

        public override AssetFile GetScript(string relativePath)
        {
            return new VirtualScriptFile(_baseUrl, relativePath, _scriptVersion);
        }

        public override AssetFile GetStyle(string relativePath)
        {
            return new VirtualStyleFile(_baseUrl, relativePath, _styleVersion);
        }
    }
}
