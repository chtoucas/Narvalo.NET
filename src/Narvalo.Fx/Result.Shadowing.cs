...
namespace Narvalo.Fx
{
    ...
    public partial class Result<T, TError>
    {
        ...
        public abstract Result<TResult, TError> ContinueWith<TResult>(Result<TResult, TError> other);
        ...
        private partial class Success_
        {
            ...
            public override Result<TResult, TError> ContinueWith<TResult>(Result<TResult, TError> other)
                => other;
