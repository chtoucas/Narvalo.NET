...
namespace Narvalo.Fx
{
    ...
    public static partial class VoidOr
    {
        ...
        /// </summary>
        private static readonly VoidOr<global::Narvalo.Fx.Unit> s_Unit = Message(global::Narvalo.Fx.Unit.Single);
        ...
        public static VoidOr<T> Message<T>(T value)
            /* T4: C# indent */
        {
    ...
    public static partial class VoidOr
    {
            ...
            /* T4: C# indent */
        {
            ...
            return @this.Bind(_ => VoidOr.Message(selector.Invoke(_)));
        }
