...
namespace Narvalo.Edu.Monads.Samples {
    ...
    public static partial class EnumerableExtensions
    {
        ...
        // REVIEW: Signature.
        public static MonadOr<TAccumulate> Collapse<TSource, TAccumulate>(
            this IEnumerable<TSource> @this,
            TAccumulate seed,
            Func<TAccumulate, TSource, MonadOr<TAccumulate>> accumulatorM,
            Func<TAccumulate, MonadOr<bool>> predicateM)
        {
             Require.Object(@this);
...
namespace Narvalo.Edu.Monads.Samples.Internal {
    ...
    static partial class EnumerableExtensions
    {
        ...
        public static MonadOr<TAccumulate> CollapseCore<TSource, TAccumulate>(
            this IEnumerable<TSource> @this,
            TAccumulate seed,
            Func<TAccumulate, TSource, MonadOr<TAccumulate>> accumulatorM,
            Func<TAccumulate, MonadOr<bool>> predicateM)
