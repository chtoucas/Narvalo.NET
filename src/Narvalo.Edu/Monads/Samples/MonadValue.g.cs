...
//
// Creation Time: 03/03/2014 00:30:49
...
namespace Narvalo.Edu.Monads.Samples {
    ...
    public static partial class EnumerableExtensions
    {
        ...
        // REVIEW: Signature.
        public static MonadValue<TAccumulate> Collapse<TSource, TAccumulate>(
            this IEnumerable<TSource> @this,
            TAccumulate seed,
            Func<TAccumulate, TSource, MonadValue<TAccumulate>> accumulatorM,
            Func<TAccumulate, MonadValue<bool>> predicateM)
            where TSource : struct
            where TAccumulate : struct
        {
...
namespace Narvalo.Edu.Monads.Samples.Internal {
    ...
    static partial class EnumerableExtensions
    {
        ...
        public static MonadValue<TAccumulate> CollapseCore<TSource, TAccumulate>(
            this IEnumerable<TSource> @this,
            TAccumulate seed,
            Func<TAccumulate, TSource, MonadValue<TAccumulate>> accumulatorM,
            Func<TAccumulate, MonadValue<bool>> predicateM)
