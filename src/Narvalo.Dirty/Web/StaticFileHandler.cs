namespace Narvalo.Web
{
    ...
    {
        readonly static TimeSpan DEFAULT_CACHE_DURATION = TimeSpan.FromDays(30);
        readonly static string[] FILE_TYPES =
           new string[] { ".css", ".js", ".html", ".htm", ".png", ".jpeg", ".jpg", ".gif", ".bmp" };

        readonly static string[] COMPRESS_FILE_TYPES =
           new string[] { ".css", ".js", ".html", ".htm" };

        [SuppressMessage("Microsoft.Performance", "CA1810:InitializeReferenceTypeStaticFieldsInline",
            Justification = "This class is not meant to be used in production")]
        ...
        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes",
            Justification = "We really do not want to re-throw the exception.")]
        [SuppressMessage("Microsoft.Globalization", "CA1308:NormalizeStringsToUppercase",
            Justification = "Simply stated, it does not apply here as it is part of the protocol.")]
        public virtual IAsyncResult BeginProcessRequest(HttpContext context, AsyncCallback cb, object extraData)
        {
            ...
            try {
                ...
                string fileExtension = file.Extension.ToLower(CultureInfo.InvariantCulture);
                ...
                return new HttpAsyncResult(cb, extraData, true, null, null);
            }
            catch (HttpException ex) {
                HttpException h = ex as HttpException;
                response.StatusCode = h.GetHttpCode();
                Debug.WriteLine(h.Message);

                return new HttpAsyncResult(cb, extraData, true, null, ex);
            }
            catch (Exception ex) {
                return new HttpAsyncResult(cb, extraData, true, null, ex);
            }
        ...
        private static bool DeliverFromCache(HttpContext context,
        ...
        private static void CacheAndDeliver(HttpContext context,
            HttpRequest request, HttpResponse response,
            string physicalFilePath, ResponseCompressionType compressionType,
        ...
        private static void TransmitFileUsingHttpResponse(HttpRequest request, HttpResponse response,
        ...
        [SuppressMessage("Microsoft.Globalization", "CA1308:NormalizeStringsToUppercase",
            Justification = "Simply stated, it does not apply here as it is part of the protocol.")]
        private static void ProduceResponseHeader(HttpResponse response, int count,
            ResponseCompressionType mode, string physicalFilePath,
            DateTime lastModified)
        {
            ...
            if (mode != ResponseCompressionType.None) {
                response.AppendHeader("Content-Encoding", mode.ToString().ToLower(CultureInfo.InvariantCulture));
            }
        ...
        #region ResponseCompressionType
