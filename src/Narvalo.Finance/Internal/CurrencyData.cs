...
namespace Narvalo.Finance.Internal
{
    ...
    /// <para>Different currencies may have the same <see cref="CurrencyData.Code"/>
    /// and <see cref="CurrencyData.NumericCode"/> but be associated to different
    ...
    internal sealed class CurrencyData
    {
        ...
        public CurrencyData(string code, short numericCode)
        {
        ...
        {
            get { Warrant.NotNull<Currency>(); return Currency.Of(Code); }
        }
        ...
        public override string ToString()
        {
            ...
            // FIXME
            return Format.Current("{0} ({1})", EnglishName, Code);
        }
