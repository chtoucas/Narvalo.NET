...
namespace Narvalo.Globalization
{
    ...
    public sealed partial class DefaultCurrencyProvider
    {
        ...
        /// </summary>
        /// <remarks>
        /// The list is built out of data obtained from the "Association Suisse de Normalisation"
        /// <see cref="!:http://www.currency-iso.org/en/home.html">website</see>.
        /// </remarks>
        /// <value>The list of currently active currencies.</value>
        internal IEnumerable<CurrencyInfo> CurrentCurrencies
        {
            get 
            {
                yield return new CurrencyInfo("AFN", 971) {
                    EnglishName = @"Afghani",
                ...
                yield return new CurrencyInfo("ALL", 8) {
                    EnglishName = @"Lek",
                    EnglishRegionName = @"ALBANIA",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("DZD", 12) {
                    EnglishName = @"Algerian Dinar",
                    EnglishRegionName = @"ALGERIA",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("USD", 840) {
                ...
                yield return new CurrencyInfo("AOA", 973) {
                    EnglishName = @"Kwanza",
                    EnglishRegionName = @"ANGOLA",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("XCD", 951) {
                ...
                yield return new CurrencyInfo("BND", 96) {
                    EnglishName = @"Brunei Dollar",
                    EnglishRegionName = @"BRUNEI DARUSSALAM",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("BGN", 975) {
                ...
                yield return new CurrencyInfo("CLF", 990) {
                    EnglishName = @"Unidad de Fomento",
                    EnglishRegionName = @"CHILE",
                    IsFund = true,
                    MinorUnits = 4,
                };
                yield return new CurrencyInfo("CLP", 152) {
                    EnglishName = @"Chilean Peso",
                    EnglishRegionName = @"CHILE",
                    MinorUnits = 0,
                };
                yield return new CurrencyInfo("CNY", 156) {
                ...
                yield return new CurrencyInfo("COP", 170) {
                    EnglishName = @"Colombian Peso",
                    EnglishRegionName = @"COLOMBIA",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("COU", 970) {
                    EnglishName = @"Unidad de Valor Real",
                    EnglishRegionName = @"COLOMBIA",
                    IsFund = true,
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("KMF", 174) {
                ...
                yield return new CurrencyInfo("HRK", 191) {
                    EnglishName = @"Croatian Kuna",
                    EnglishRegionName = @"CROATIA",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("CUC", 931) {
                    EnglishName = @"Peso Convertible",
                    EnglishRegionName = @"CUBA",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("CUP", 192) {
                ...
                yield return new CurrencyInfo("CZK", 203) {
                    EnglishName = @"Czech Koruna",
                    EnglishRegionName = @"CZECH REPUBLIC",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("DKK", 208) {
                    EnglishName = @"Danish Krone",
                    EnglishRegionName = @"DENMARK",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("DJF", 262) {
                ...
                yield return new CurrencyInfo("DOP", 214) {
                ...
                yield return new CurrencyInfo("EGP", 818) {
                    EnglishName = @"Egyptian Pound",
                    EnglishRegionName = @"EGYPT",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("SVC", 222) {
                ...
                yield return new CurrencyInfo("ERN", 232) {
                    EnglishName = @"Nakfa",
                ...
                yield return new CurrencyInfo("ETB", 230) {
                ...
                yield return new CurrencyInfo("FKP", 238) {
                ...
                yield return new CurrencyInfo("FJD", 242) {
                ...
                yield return new CurrencyInfo("XPF", 953) {
                ...
                yield return new CurrencyInfo("GMD", 270) {
                    EnglishName = @"Dalasi",
                    EnglishRegionName = @"GAMBIA",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("GEL", 981) {
                    EnglishName = @"Lari",
                ...
                yield return new CurrencyInfo("GHS", 936) {
                    EnglishName = @"Ghana Cedi",
                    EnglishRegionName = @"GHANA",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("GIP", 292) {
                ...
                yield return new CurrencyInfo("GTQ", 320) {
                    EnglishName = @"Quetzal",
                    EnglishRegionName = @"GUATEMALA",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("GBP", 826) {
                    EnglishName = @"Pound Sterling",
                    EnglishRegionName = @"GUERNSEY",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("GNF", 324) {
                ...
                yield return new CurrencyInfo("GYD", 328) {
                    EnglishName = @"Guyana Dollar",
                    EnglishRegionName = @"GUYANA",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("HTG", 332) {
                    EnglishName = @"Gourde",
                ...
                yield return new CurrencyInfo("HNL", 340) {
                    EnglishName = @"Lempira",
                    EnglishRegionName = @"HONDURAS",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("HKD", 344) {
                    EnglishName = @"Hong Kong Dollar",
                    EnglishRegionName = @"HONG KONG",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("HUF", 348) {
                    EnglishName = @"Forint",
                    EnglishRegionName = @"HUNGARY",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("ISK", 352) {
                ...
                yield return new CurrencyInfo("ILS", 376) {
                ...
                yield return new CurrencyInfo("JMD", 388) {
                    EnglishName = @"Jamaican Dollar",
                    EnglishRegionName = @"JAMAICA",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("JPY", 392) {
                    EnglishName = @"Yen",
                ...
                yield return new CurrencyInfo("JOD", 400) {
                    EnglishName = @"Jordanian Dinar",
                    EnglishRegionName = @"JORDAN",
                    MinorUnits = 3,
                };
                yield return new CurrencyInfo("KZT", 398) {
                    EnglishName = @"Tenge",
                    EnglishRegionName = @"KAZAKHSTAN",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("KES", 404) {
                ...
                yield return new CurrencyInfo("LBP", 422) {
                    EnglishName = @"Lebanese Pound",
                    EnglishRegionName = @"LEBANON",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("LSL", 426) {
                    EnglishName = @"Loti",
                    EnglishRegionName = @"LESOTHO",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("ZAR", 710) {
                    EnglishName = @"Rand",
                    EnglishRegionName = @"LESOTHO",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("LRD", 430) {
                    EnglishName = @"Liberian Dollar",
                    EnglishRegionName = @"LIBERIA",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("LYD", 434) {
                    EnglishName = @"Libyan Dinar",
                    EnglishRegionName = @"LIBYA",
                    MinorUnits = 3,
                };
                yield return new CurrencyInfo("CHF", 756) {
                ...
                yield return new CurrencyInfo("MOP", 446) {
                    EnglishName = @"Pataca",
                    EnglishRegionName = @"MACAO",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("MKD", 807) {
                    EnglishName = @"Denar",
                    EnglishRegionName = @"MACEDONIA, THE FORMER YUGOSLAV REPUBLIC OF",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("MGA", 969) {
                    EnglishName = @"Malagasy Ariary",
                    EnglishRegionName = @"MADAGASCAR",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("MWK", 454) {
                    EnglishName = @"Kwacha",
                    EnglishRegionName = @"MALAWI",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("MYR", 458) {
                    EnglishName = @"Malaysian Ringgit",
                    EnglishRegionName = @"MALAYSIA",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("MVR", 462) {
                    EnglishName = @"Rufiyaa",
                ...
                yield return new CurrencyInfo("MRO", 478) {
                    EnglishName = @"Ouguiya",
                    EnglishRegionName = @"MAURITANIA",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("MUR", 480) {
                ...
                yield return new CurrencyInfo("MDL", 498) {
                ...
                yield return new CurrencyInfo("MNT", 496) {
                    EnglishName = @"Tugrik",
                ...
                yield return new CurrencyInfo("MAD", 504) {
                    EnglishName = @"Moroccan Dirham",
                    EnglishRegionName = @"MOROCCO",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("MZN", 943) {
                    EnglishName = @"Mozambique Metical",
                    EnglishRegionName = @"MOZAMBIQUE",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("MMK", 104) {
                    EnglishName = @"Kyat",
                    EnglishRegionName = @"MYANMAR",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("NAD", 516) {
                ...
                yield return new CurrencyInfo("NPR", 524) {
                ...
                yield return new CurrencyInfo("NIO", 558) {
                ...
                yield return new CurrencyInfo("NGN", 566) {
                    EnglishName = @"Naira",
                ...
                yield return new CurrencyInfo("OMR", 512) {
                    EnglishName = @"Rial Omani",
                    EnglishRegionName = @"OMAN",
                    MinorUnits = 3,
                };
                yield return new CurrencyInfo("PKR", 586) {
                ...
                yield return new CurrencyInfo("PAB", 590) {
                    EnglishName = @"Balboa",
                ...
                yield return new CurrencyInfo("PGK", 598) {
                    EnglishName = @"Kina",
                    EnglishRegionName = @"PAPUA NEW GUINEA",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("PYG", 600) {
                    EnglishName = @"Guarani",
                    EnglishRegionName = @"PARAGUAY",
                    MinorUnits = 0,
                };
                yield return new CurrencyInfo("PEN", 604) {
                    EnglishName = @"Nuevo Sol",
                    EnglishRegionName = @"PERU",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("PHP", 608) {
                ...
                yield return new CurrencyInfo("PLN", 985) {
                    EnglishName = @"Zloty",
                ...
                yield return new CurrencyInfo("QAR", 634) {
                ...
                yield return new CurrencyInfo("SHP", 654) {
                ...
                yield return new CurrencyInfo("WST", 882) {
                    EnglishName = @"Tala",
                ...
                yield return new CurrencyInfo("STD", 678) {
                    EnglishName = @"Dobra",
                    EnglishRegionName = @"SAO TOME AND PRINCIPE",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("SAR", 682) {
                ...
                yield return new CurrencyInfo("RSD", 941) {
                    EnglishName = @"Serbian Dinar",
                    EnglishRegionName = @"SERBIA",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("SCR", 690) {
                    EnglishName = @"Seychelles Rupee",
                    EnglishRegionName = @"SEYCHELLES",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("SLL", 694) {
                    EnglishName = @"Leone",
                    EnglishRegionName = @"SIERRA LEONE",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("SGD", 702) {
                ...
                yield return new CurrencyInfo("XSU", 994) {
                    EnglishName = @"Sucre",
                ...
                yield return new CurrencyInfo("SBD", 90) {
                    EnglishName = @"Solomon Islands Dollar",
                    EnglishRegionName = @"SOLOMON ISLANDS",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("SOS", 706) {
                ...
                yield return new CurrencyInfo("SSP", 728) {
                ...
                yield return new CurrencyInfo("LKR", 144) {
                ...
                yield return new CurrencyInfo("SRD", 968) {
                ...
                yield return new CurrencyInfo("SZL", 748) {
                    EnglishName = @"Lilangeni",
                    EnglishRegionName = @"SWAZILAND",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("SEK", 752) {
                    EnglishName = @"Swedish Krona",
                    EnglishRegionName = @"SWEDEN",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("CHE", 947) {
                ...
                yield return new CurrencyInfo("TOP", 776) {
                    EnglishName = @"Pa’anga",
                    EnglishRegionName = @"TONGA",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("TTD", 780) {
                    EnglishName = @"Trinidad and Tobago Dollar",
                    EnglishRegionName = @"TRINIDAD AND TOBAGO",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("TND", 788) {
                ...
                yield return new CurrencyInfo("TMT", 934) {
                ...
                yield return new CurrencyInfo("UGX", 800) {
                    EnglishName = @"Uganda Shilling",
                    EnglishRegionName = @"UGANDA",
                    MinorUnits = 0,
                };
                yield return new CurrencyInfo("UAH", 980) {
                    EnglishName = @"Hryvnia",
                    EnglishRegionName = @"UKRAINE",
                    MinorUnits = 2,
                };
                yield return new CurrencyInfo("AED", 784) {
                ...
                yield return new CurrencyInfo("USN", 997) {
                ...
                yield return new CurrencyInfo("VND", 704) {
                    EnglishName = @"Dong",
        ...
        internal IEnumerable<CurrencyInfo> LegacyCurrencies
        {
            get 
            {
