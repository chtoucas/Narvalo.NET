...
@call "%~dp0\tools\MSBuild.cmd" "%~dp0\tools\Make.Foundations.proj" /t:FullRebuild /p:Retail=true /v:m /m /nr:false /fl /flp:logfile=%LogFile%;verbosity=normal;encoding=utf-8
